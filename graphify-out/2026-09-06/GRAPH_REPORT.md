...
## Corpus Check
- 36 files · ~104,506 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 331 nodes · 426 edges · 24 communities (18 shown, 6 thin omitted)
...
3. `useSahayamStore()` - 15 edges
4. `Sahayam Silence Dataset` - 15 edges
5. `Sahayam Silence Dataset — Complete Summary` - 11 edges
6. `Scenarios: Testing Silence Detection` - 10 edges
7. `Tables` - 9 edges
8. `Dataset Design Principles` - 9 edges
9. `main()` - 8 edges
10. `Sahayam Silence Scorer — Implementation Guide` - 8 edges
...
Cohesion: 0.12
Nodes (23): Dark Neutral & Semantic Accent Color System, Human Proximity Confidence Score (HPCS), Dark Zone Silence Anomaly Scorer, Incident Command Live Triage Console, BasemapKey, MapStatus, SilenceMap(), SilenceMapProps (+15 more)
